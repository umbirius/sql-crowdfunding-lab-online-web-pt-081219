...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  "SELECT projects.title FROM projects JOIN pledges WHERE projects.id = pledges.project_id  " #GROUP BY pledges.project_id WHERE SUM(pledges.amount) > projects.funding_goal "
end
